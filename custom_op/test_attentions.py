...
def main():
    ...
    q = torch.randn((32, 32), dtype=torch.float16, device=device)
    k = torch.randn((32, 32), dtype=torch.float16, device=device)
    v = torch.randn((32, 32), dtype=torch.float16, device=device)
